  ...
  class MapManager{
    ...
    setDownwindCorridors(analyses,show=true){
      ...
      if(count){
        ...
        this.makeLegend('downwind','Rüzgâr Bazlı İzleme Koridoru',`<div class="legendLine"><i style="background:#7be6ff"></i><span>Koridordaki şebeke varlığı</span></div><div class="legendLine"><span class="substationSquare substation-risk" style="display:inline-block"></span><span>Koridordaki trafo merkezi</span></div><div class="sourceNote">Yangın olayından maksimum ${C.downwindMaxDistanceKm} km, ±${C.downwind.halfAngleDeg}° sektör. Rüzgâr alanını operasyonel tarama için kullanır; gerçek duman yörüngesi değildir.</div>`);
      }
    }
    ...
    sectorSubstationIcon(){return L.divIcon({className:'substationIconWrap',html:'<span class="substationSquare substation-risk"></span>',iconSize:[10,10],iconAnchor:[5,5]});}
