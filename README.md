...
> **Sürüm:** v3.4.6 · **Canlı:** <https://murathany90.github.io/tr_wildfire/> · **Harita serbesttir; veri Türkiye ile sınırlıdır.**
...
Mevcut durum: **130/130 test geçti** (v3.4.6 itibarıyla). Paket; FRP filtresi, clustering, dedupe, MTG frame/backfill davranışı, varsayılan katmanlar, risk sembolleri, risk özeti paneli, DOM ID tekillik sözleşmesi, karşılıklı özel panel davranışı + aria senkronu, CSS mobil düzeni, sürüm tutarlılığı ve kaldırılan kaynakların kalıntılarının olmadığını (AtmoHub/GFW/FirePolygon yokluk assertion'ları) doğrular.
